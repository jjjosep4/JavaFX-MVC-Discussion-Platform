...
public class EmailAddressRecognizer {
	...
	public static String checkEmailAddress(String input) {
		...
		case 0:
			...
			emailAddressIndexofError = currentCharNdx;		// Copy the index of the current character;
			emailAddressErrorMessage = "Must enter a complete email address containing '@' and domain.\n";
			return emailAddressErrorMessage;

		case 1:
			// State 1 is not a final state, so we can return a very specific error message
			emailAddressIndexofError = currentCharNdx;		// Copy the index of the current character;
			emailAddressErrorMessage = "Email needs '@' and domain.\n";
			return emailAddressErrorMessage;
			// Replace this with the required code
		...
		case 2:
			...
			emailAddressIndexofError = currentCharNdx;		// Copy the index of the current character;
			emailAddressErrorMessage = "Email needs a complete domain after '@'.\n";
			return emailAddressErrorMessage;
			// Replace this with the required code
		...
		case 4:
			...
			emailAddressIndexofError = currentCharNdx;		// Copy the index of the current character;
			emailAddressErrorMessage = "Domain name must end in letter or number.\n";
			return emailAddressErrorMessage;
			// Replace this with the required code
